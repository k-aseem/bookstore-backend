...
public class ApiResource {
    ...
    //to find something by name instead of by ID:
    // -- find the category by name ==> category
    // -- get the category ID ==> categoryId = category.getCategoryId()
    // -- return the result of finding by ID
